...
/*  wire   SYNOPSYS_UNCONNECTED__0, SYNOPSYS_UNCONNECTED__1,
  ...
  KeyUpdate_1 ku31 ( .old_key(key31), .round({\*Logic1* , \*Logic1* ,
        ...
        SYNOPSYS_UNCONNECTED__12, SYNOPSYS_UNCONNECTED__13,
        SYNOPSYS_UNCONNECTED__14, SYNOPSYS_UNCONNECTED__15}) );*/
  Pbox pb1 ( .idat(dat1_1), .odat(dat1_2) );
  Sbox sb1 ( .idat(dat1_2), .odat(dat1_3) );
  TIE1LEHMX1 U3 ( .O(\*Logic1* ) );
  TIE0LEHMX1 U4 ( .O(\*Logic0* ) );
  XOR2LEHMX1 U5 ( .I1(key31[25]), .I2(dat1_3[9]), .O(odat[9]) );
  XOR2LEHMX1 U6 ( .I1(key31[24]), .I2(dat1_3[8]), .O(odat[8]) );
  XOR2LEHMX1 U7 ( .I1(key31[23]), .I2(dat1_3[7]), .O(odat[7]) );
  XOR2LEHMX1 U8 ( .I1(key31[22]), .I2(dat1_3[6]), .O(odat[6]) );
  XOR2LEHMX1 U9 ( .I1(key31[79]), .I2(dat1_3[63]), .O(odat[63]) );
  XOR2LEHMX1 U10 ( .I1(key31[78]), .I2(dat1_3[62]), .O(odat[62]) );
  XOR2LEHMX1 U11 ( .I1(key31[77]), .I2(dat1_3[61]), .O(odat[61]) );
  XOR2LEHMX1 U12 ( .I1(key31[76]), .I2(dat1_3[60]), .O(odat[60]) );
  XOR2LEHMX1 U13 ( .I1(key31[21]), .I2(dat1_3[5]), .O(odat[5]) );
  XOR2LEHMX1 U14 ( .I1(key31[75]), .I2(dat1_3[59]), .O(odat[59]) );
  XOR2LEHMX1 U15 ( .I1(key31[74]), .I2(dat1_3[58]), .O(odat[58]) );
  XOR2LEHMX1 U16 ( .I1(key31[73]), .I2(dat1_3[57]), .O(odat[57]) );
  XOR2LEHMX1 U17 ( .I1(key31[72]), .I2(dat1_3[56]), .O(odat[56]) );
  XOR2LEHMX1 U18 ( .I1(key31[71]), .I2(dat1_3[55]), .O(odat[55]) );
  XOR2LEHMX1 U19 ( .I1(key31[70]), .I2(dat1_3[54]), .O(odat[54]) );
  XOR2LEHMX1 U20 ( .I1(key31[69]), .I2(dat1_3[53]), .O(odat[53]) );
  XOR2LEHMX1 U21 ( .I1(key31[68]), .I2(dat1_3[52]), .O(odat[52]) );
  XOR2LEHMX1 U22 ( .I1(key31[67]), .I2(dat1_3[51]), .O(odat[51]) );
  XOR2LEHMX1 U23 ( .I1(key31[66]), .I2(dat1_3[50]), .O(odat[50]) );
  XOR2LEHMX1 U24 ( .I1(key31[20]), .I2(dat1_3[4]), .O(odat[4]) );
  XOR2LEHMX1 U25 ( .I1(key31[65]), .I2(dat1_3[49]), .O(odat[49]) );
  XOR2LEHMX1 U26 ( .I1(key31[64]), .I2(dat1_3[48]), .O(odat[48]) );
  XOR2LEHMX1 U27 ( .I1(key31[63]), .I2(dat1_3[47]), .O(odat[47]) );
  XOR2LEHMX1 U28 ( .I1(key31[62]), .I2(dat1_3[46]), .O(odat[46]) );
  XOR2LEHMX1 U29 ( .I1(key31[61]), .I2(dat1_3[45]), .O(odat[45]) );
  XOR2LEHMX1 U30 ( .I1(key31[60]), .I2(dat1_3[44]), .O(odat[44]) );
  XOR2LEHMX1 U31 ( .I1(key31[59]), .I2(dat1_3[43]), .O(odat[43]) );
  XOR2LEHMX1 U32 ( .I1(key31[58]), .I2(dat1_3[42]), .O(odat[42]) );
  XOR2LEHMX1 U33 ( .I1(key31[57]), .I2(dat1_3[41]), .O(odat[41]) );
  XOR2LEHMX1 U34 ( .I1(key31[56]), .I2(dat1_3[40]), .O(odat[40]) );
  XOR2LEHMX1 U35 ( .I1(key31[19]), .I2(dat1_3[3]), .O(odat[3]) );
  XOR2LEHMX1 U36 ( .I1(key31[55]), .I2(dat1_3[39]), .O(odat[39]) );
  XOR2LEHMX1 U37 ( .I1(key31[54]), .I2(dat1_3[38]), .O(odat[38]) );
  XOR2LEHMX1 U38 ( .I1(key31[53]), .I2(dat1_3[37]), .O(odat[37]) );
  XOR2LEHMX1 U39 ( .I1(key31[52]), .I2(dat1_3[36]), .O(odat[36]) );
  XOR2LEHMX1 U40 ( .I1(key31[51]), .I2(dat1_3[35]), .O(odat[35]) );
  XOR2LEHMX1 U41 ( .I1(key31[50]), .I2(dat1_3[34]), .O(odat[34]) );
  XOR2LEHMX1 U42 ( .I1(key31[49]), .I2(dat1_3[33]), .O(odat[33]) );
  XOR2LEHMX1 U43 ( .I1(key31[48]), .I2(dat1_3[32]), .O(odat[32]) );
  XOR2LEHMX1 U44 ( .I1(key31[47]), .I2(dat1_3[31]), .O(odat[31]) );
  XOR2LEHMX1 U45 ( .I1(key31[46]), .I2(dat1_3[30]), .O(odat[30]) );
  XOR2LEHMX1 U46 ( .I1(key31[18]), .I2(dat1_3[2]), .O(odat[2]) );
  XOR2LEHMX1 U47 ( .I1(key31[45]), .I2(dat1_3[29]), .O(odat[29]) );
  XOR2LEHMX1 U48 ( .I1(key31[44]), .I2(dat1_3[28]), .O(odat[28]) );
  XOR2LEHMX1 U49 ( .I1(key31[43]), .I2(dat1_3[27]), .O(odat[27]) );
  XOR2LEHMX1 U50 ( .I1(key31[42]), .I2(dat1_3[26]), .O(odat[26]) );
  XOR2LEHMX1 U51 ( .I1(key31[41]), .I2(dat1_3[25]), .O(odat[25]) );
  XOR2LEHMX1 U52 ( .I1(key31[40]), .I2(dat1_3[24]), .O(odat[24]) );
  XOR2LEHMX1 U53 ( .I1(key31[39]), .I2(dat1_3[23]), .O(odat[23]) );
  XOR2LEHMX1 U54 ( .I1(key31[38]), .I2(dat1_3[22]), .O(odat[22]) );
  XOR2LEHMX1 U55 ( .I1(key31[37]), .I2(dat1_3[21]), .O(odat[21]) );
  XOR2LEHMX1 U56 ( .I1(key31[36]), .I2(dat1_3[20]), .O(odat[20]) );
  XOR2LEHMX1 U57 ( .I1(key31[17]), .I2(dat1_3[1]), .O(odat[1]) );
  XOR2LEHMX1 U58 ( .I1(key31[35]), .I2(dat1_3[19]), .O(odat[19]) );
  XOR2LEHMX1 U59 ( .I1(key31[34]), .I2(dat1_3[18]), .O(odat[18]) );
  XOR2LEHMX1 U60 ( .I1(key31[33]), .I2(dat1_3[17]), .O(odat[17]) );
  XOR2LEHMX1 U61 ( .I1(key31[32]), .I2(dat1_3[16]), .O(odat[16]) );
  XOR2LEHMX1 U62 ( .I1(key31[31]), .I2(dat1_3[15]), .O(odat[15]) );
  XOR2LEHMX1 U63 ( .I1(key31[30]), .I2(dat1_3[14]), .O(odat[14]) );
  XOR2LEHMX1 U64 ( .I1(key31[29]), .I2(dat1_3[13]), .O(odat[13]) );
  XOR2LEHMX1 U65 ( .I1(key31[28]), .I2(dat1_3[12]), .O(odat[12]) );
  XOR2LEHMX1 U66 ( .I1(key31[27]), .I2(dat1_3[11]), .O(odat[11]) );
  XOR2LEHMX1 U67 ( .I1(key31[26]), .I2(dat1_3[10]), .O(odat[10]) );
  XOR2LEHMX1 U68 ( .I1(key31[16]), .I2(dat1_3[0]), .O(odat[0]) );
  XOR2LEHMX1 U69 ( .I1(key32[25]), .I2(idat[9]), .O(dat1_1[9]) );
  XOR2LEHMX1 U70 ( .I1(key32[24]), .I2(idat[8]), .O(dat1_1[8]) );
  XOR2LEHMX1 U71 ( .I1(key32[23]), .I2(idat[7]), .O(dat1_1[7]) );
  XOR2LEHMX1 U72 ( .I1(key32[22]), .I2(idat[6]), .O(dat1_1[6]) );
  XOR2LEHMX1 U73 ( .I1(key32[79]), .I2(idat[63]), .O(dat1_1[63]) );
  XOR2LEHMX1 U74 ( .I1(key32[78]), .I2(idat[62]), .O(dat1_1[62]) );
  XOR2LEHMX1 U75 ( .I1(key32[77]), .I2(idat[61]), .O(dat1_1[61]) );
  XOR2LEHMX1 U76 ( .I1(key32[76]), .I2(idat[60]), .O(dat1_1[60]) );
  XOR2LEHMX1 U77 ( .I1(key32[21]), .I2(idat[5]), .O(dat1_1[5]) );
  XOR2LEHMX1 U78 ( .I1(key32[75]), .I2(idat[59]), .O(dat1_1[59]) );
  XOR2LEHMX1 U79 ( .I1(key32[74]), .I2(idat[58]), .O(dat1_1[58]) );
  XOR2LEHMX1 U80 ( .I1(key32[73]), .I2(idat[57]), .O(dat1_1[57]) );
  XOR2LEHMX1 U81 ( .I1(key32[72]), .I2(idat[56]), .O(dat1_1[56]) );
  XOR2LEHMX1 U82 ( .I1(key32[71]), .I2(idat[55]), .O(dat1_1[55]) );
  XOR2LEHMX1 U83 ( .I1(key32[70]), .I2(idat[54]), .O(dat1_1[54]) );
  XOR2LEHMX1 U84 ( .I1(key32[69]), .I2(idat[53]), .O(dat1_1[53]) );
  XOR2LEHMX1 U85 ( .I1(key32[68]), .I2(idat[52]), .O(dat1_1[52]) );
  XOR2LEHMX1 U86 ( .I1(key32[67]), .I2(idat[51]), .O(dat1_1[51]) );
  XOR2LEHMX1 U87 ( .I1(key32[66]), .I2(idat[50]), .O(dat1_1[50]) );
  XOR2LEHMX1 U88 ( .I1(key32[20]), .I2(idat[4]), .O(dat1_1[4]) );
  XOR2LEHMX1 U89 ( .I1(key32[65]), .I2(idat[49]), .O(dat1_1[49]) );
  XOR2LEHMX1 U90 ( .I1(key32[64]), .I2(idat[48]), .O(dat1_1[48]) );
  XOR2LEHMX1 U91 ( .I1(key32[63]), .I2(idat[47]), .O(dat1_1[47]) );
  XOR2LEHMX1 U92 ( .I1(key32[62]), .I2(idat[46]), .O(dat1_1[46]) );
  XOR2LEHMX1 U93 ( .I1(key32[61]), .I2(idat[45]), .O(dat1_1[45]) );
  XOR2LEHMX1 U94 ( .I1(key32[60]), .I2(idat[44]), .O(dat1_1[44]) );
  XOR2LEHMX1 U95 ( .I1(key32[59]), .I2(idat[43]), .O(dat1_1[43]) );
  XOR2LEHMX1 U96 ( .I1(key32[58]), .I2(idat[42]), .O(dat1_1[42]) );
  XOR2LEHMX1 U97 ( .I1(key32[57]), .I2(idat[41]), .O(dat1_1[41]) );
  XOR2LEHMX1 U98 ( .I1(key32[56]), .I2(idat[40]), .O(dat1_1[40]) );
  XOR2LEHMX1 U99 ( .I1(key32[19]), .I2(idat[3]), .O(dat1_1[3]) );
  XOR2LEHMX1 U100 ( .I1(key32[55]), .I2(idat[39]), .O(dat1_1[39]) );
  XOR2LEHMX1 U101 ( .I1(key32[54]), .I2(idat[38]), .O(dat1_1[38]) );
  XOR2LEHMX1 U102 ( .I1(key32[53]), .I2(idat[37]), .O(dat1_1[37]) );
  XOR2LEHMX1 U103 ( .I1(key32[52]), .I2(idat[36]), .O(dat1_1[36]) );
  XOR2LEHMX1 U104 ( .I1(key32[51]), .I2(idat[35]), .O(dat1_1[35]) );
  XOR2LEHMX1 U105 ( .I1(key32[50]), .I2(idat[34]), .O(dat1_1[34]) );
  XOR2LEHMX1 U106 ( .I1(key32[49]), .I2(idat[33]), .O(dat1_1[33]) );
  XOR2LEHMX1 U107 ( .I1(key32[48]), .I2(idat[32]), .O(dat1_1[32]) );
  XOR2LEHMX1 U108 ( .I1(key32[47]), .I2(idat[31]), .O(dat1_1[31]) );
  XOR2LEHMX1 U109 ( .I1(key32[46]), .I2(idat[30]), .O(dat1_1[30]) );
  XOR2LEHMX1 U110 ( .I1(key32[18]), .I2(idat[2]), .O(dat1_1[2]) );
  XOR2LEHMX1 U111 ( .I1(key32[45]), .I2(idat[29]), .O(dat1_1[29]) );
  XOR2LEHMX1 U112 ( .I1(key32[44]), .I2(idat[28]), .O(dat1_1[28]) );
  XOR2LEHMX1 U113 ( .I1(key32[43]), .I2(idat[27]), .O(dat1_1[27]) );
  XOR2LEHMX1 U114 ( .I1(key32[42]), .I2(idat[26]), .O(dat1_1[26]) );
  XOR2LEHMX1 U115 ( .I1(key32[41]), .I2(idat[25]), .O(dat1_1[25]) );
  XOR2LEHMX1 U116 ( .I1(key32[40]), .I2(idat[24]), .O(dat1_1[24]) );
  XOR2LEHMX1 U117 ( .I1(key32[39]), .I2(idat[23]), .O(dat1_1[23]) );
  XOR2LEHMX1 U118 ( .I1(key32[38]), .I2(idat[22]), .O(dat1_1[22]) );
  XOR2LEHMX1 U119 ( .I1(key32[37]), .I2(idat[21]), .O(dat1_1[21]) );
  XOR2LEHMX1 U120 ( .I1(key32[36]), .I2(idat[20]), .O(dat1_1[20]) );
  XOR2LEHMX1 U121 ( .I1(key32[17]), .I2(idat[1]), .O(dat1_1[1]) );
  XOR2LEHMX1 U122 ( .I1(key32[35]), .I2(idat[19]), .O(dat1_1[19]) );
  XOR2LEHMX1 U123 ( .I1(key32[34]), .I2(idat[18]), .O(dat1_1[18]) );
  XOR2LEHMX1 U124 ( .I1(key32[33]), .I2(idat[17]), .O(dat1_1[17]) );
  XOR2LEHMX1 U125 ( .I1(key32[32]), .I2(idat[16]), .O(dat1_1[16]) );
  XOR2LEHMX1 U126 ( .I1(key32[31]), .I2(idat[15]), .O(dat1_1[15]) );
  XOR2LEHMX1 U127 ( .I1(key32[30]), .I2(idat[14]), .O(dat1_1[14]) );
  XOR2LEHMX1 U128 ( .I1(key32[29]), .I2(idat[13]), .O(dat1_1[13]) );
  XOR2LEHMX1 U129 ( .I1(key32[28]), .I2(idat[12]), .O(dat1_1[12]) );
  XOR2LEHMX1 U130 ( .I1(key32[27]), .I2(idat[11]), .O(dat1_1[11]) );
  XOR2LEHMX1 U131 ( .I1(key32[26]), .I2(idat[10]), .O(dat1_1[10]) );
  XOR2LEHMX1 U132 ( .I1(key32[16]), .I2(idat[0]), .O(dat1_1[0]) );
endmodule
